...
int main(int argc, char** argv){
  ...
  plot BinsSRSingleHiggsPlot(*fillRA2b10Bins,"AnalysisRA2b10Bins_tagSR","i^th Bin",10,0.5,10.5);
  plot BinsSRAntiTagPlot(*fillRA2b10Bins,"AnalysisRA2b10Bins_antitagSR","i^th Bin",10,0.5,10.5);
  plot BinsSBSingleHiggsPlot(*fillRA2b10Bins,"AnalysisRA2b10Bins_tagSB","i^th Bin",10,0.5,10.5);
  plot BinsSBAntiTagPlot(*fillRA2b10Bins,"AnalysisRA2b10Bins_antitagSB","i^th Bin",10,0.5,10.5);
  ...
  TFile* outputFile = new TFile("datacardInputsRA2b10.root","RECREATE");
