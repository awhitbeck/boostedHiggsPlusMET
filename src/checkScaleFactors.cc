...
void checkScaleFactors(TString tag = "_singleMu", bool doubletag = true, TString baseDir="./",int integrate_from=1,int integrate_to=4){
    ...
    // ---------------------------------------------
    TH1F* doubletagSRdata = (TH1F*) f->Get("MET_"+tagString+"SR_data");
    ...
    TH1F* doubletagSRmc = (TH1F*) f->Get("MET_"+tagString+"SR_sum");
    ...
    TH1F* doubletagSBdata = (TH1F*) f->Get("MET_"+tagString+"SB_data");
    ...
    TH1F* doubletagSBmc = (TH1F*) f->Get("MET_"+tagString+"SB_sum");
    ...
    TH1F* antitagSRdata = (TH1F*) f->Get("MET_antitagSR_data");
    ...
    TH1F* antitagSRmc = (TH1F*) f->Get("MET_antitagSR_sum");
    ...
    TH1F* antitagSBdata = (TH1F*) f->Get("MET_antitagSB_data");
    ...
    TH1F* antitagSBmc = (TH1F*) f->Get("MET_antitagSB_sum");
