...
# condor_submit batchExecute.jdl exec_name="cutFlow_lowDphi" arguments="${hash} cutFlow 3"

condor_submit batchExecute.jdl exec_name="plotObs_baseline" arguments="${hash} plotObs_baseline baseline"
condor_submit batchExecute.jdl exec_name="plotObs_looseZtag" arguments="${hash} plotObs_baseline looseZtag"
condor_submit batchExecute.jdl exec_name="plotObs_tightZtag" arguments="${hash} plotObs_baseline tightZtag"
...
# condor_submit batchExecute.jdl exec_name="ALPHABET_photon_loose" arguments="${hash} ALPHABET_photon 1"
