...
hadd -f -k -v 0 -j6 ${skimType}_TTJets.root ${skimType}_TTJets_HT-600to800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root ${skimType}_TTJets_HT-800to1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root ${skimType}_TTJets_HT-1200to2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root ${skimType}_TTJets_HT-2500toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root 

rm ${skimType}_TTJets_HT-600to800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root ${skimType}_TTJets_HT-800to1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root ${skimType}_TTJets_HT-1200to2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root ${skimType}_TTJets_HT-2500toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root 
...
hadd -f -k -v 0 -j6 ${skimType}_${sample}_1xxx.root ~/eos/${skims}/${skimType}_${sample}_1[0-9][0-9][0-9].root
hadd -f -k -v 0 -j6 ${skimType}_${sample}_2xxx.root ~/eos/${skims}/${skimType}_${sample}_2[0-9][0-9][0-9].root
hadd -f -k -v 0 -j6 ${skimType}_${sample}_3xxx.root ~/eos/${skims}/${skimType}_${sample}_3[0-9][0-9][0-9].root
hadd -f -k -v 0 -j6 ${skimType}_${sample}_4xxx.root ~/eos/${skims}/${skimType}_${sample}_4[0-9][0-9][0-9].root
