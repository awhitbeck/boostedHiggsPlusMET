...
public : 
  ...
  skimSamples(){
    ...
    mGluino1400->Add("heppySkim_T5GH_mGluino_1400_mNLSP_1350_0.root");
    ...
    mGluino1500->Add("heppySkim_T5GH_mGluino_1500_mNLSP_1450_0.root");
    signalNtuples.push_back(new heppySkimTree(mGluino1500));
    signalSampleName.push_back("mGluino1500");
    lineColor.push_back(kRed+1);
    mGluino1600 = new TChain("tree");
    mGluino1600->Add("heppySkim_T5GH_mGluino_1600_mNLSP_1550_0.root");
    ...
    mGluino1700->Add("heppySkim_T5GH_mGluino_1700_mNLSP_1650_0.root");
